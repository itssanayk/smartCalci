...
win.configure(bg='#2D4356')

l1 = Label(win , text='I am a smart calculator',width=20 , padx=3)
l1.place(x=150,y=10)
l2 = Label(win , text='My name is Calc!' , padx=3)
l2.place(x=180,y=40)
l3 = Label(win , text='How may i help you' , padx=3)
...
b1 = Button(win , text='Find the Answer Calci' ,command=calculate)
